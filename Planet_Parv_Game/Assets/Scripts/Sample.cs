...
public class Sample : MonoBehaviour
{
    ...
    private List<string> sampleTextOptions = new List<string> {
        ...
        "The soil on this contains perchlorates, a type of salt that's toxic to humans. It's a reminder of how hostile this planet is. But it also has potential: scientists think we might one day use these salts to extract oxygen or as part of fuel production.",
